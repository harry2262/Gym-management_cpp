...
cout << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\tHow many members do you want toadd: ";
cin >> mn;
system("cls");
for (int i = 0; i < mn; i++)
{
...
if (back == "Y" || back == "y")
{
cout << "\n\n\t\t\t\t\t\t\t\tYou filled all Entries of " << i + 1 << "/" << mn << " membersuccessfully...";
getch();
cout << endl;
}
...
{
cout << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\tNo such ID in database"<<endl;cout << "\t\t\t\t\t\t\t\tPress any key to choose another option...";
}
}
getch();
}
...
void get_data()
{
cout << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\tHow many employees do you want toadd: ";
cin >> en;
system("cls");
for (i = 0; i < en; i++)
{
...
if (back == "Y" || back == "y")
{
cout << "\n\n\t\t\t\t\t\t\t\tYou filled all Entries of " << i + 1 << "/" << en << " employeesuccessfully...";
getch();
cout << endl;
}
else if (back == "N" || back == "n")
...
cout << "\t\t\t\t\t| |\n";
cout << "\t\t\t\t\t| |\n";
cout << "\t\t\t\t\t| Made By - Jashanpreet Singh\n";
cout <<
...
system("cls");
cout << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\tOOPS!!!!" <<endl;
cout << "\t\t\t\t\t\t\tNote: No Record To Display plz Go Back And Enter SomeEntries...";
getch();
}
goto get_data;
}
